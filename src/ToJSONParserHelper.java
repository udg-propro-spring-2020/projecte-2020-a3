...
public class ToJSONParserHelper {
    ...
    public static String propertyToJSON(String propName, Object value, Boolean isString, Boolean trailingComa, String identation)
        ...
        if (listName.isEmpty() || listName == null) {
            ...
            if (list.isEmpty() || list == null) {
                ...
                s.append(identation)
                    ...
                    .append(
                        inQuotes 
                        ? valueToJSONString(list.get(list.size() - 1)) 
